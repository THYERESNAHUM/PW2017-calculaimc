...
```
mvn org.apache.tomcat.maven:tomcat7-maven-plugin:run -Dmaven.tomcat.port=9090 -Dmaven.tomcat.path=/calculaimc
```

**Para Acessar Calculadora IMC**

http://localhost:8080/calculaimc em qualquer navegador(atenção a porta de conexão).
